...
function Steps() {
	...
	return (
		<ol className='rounded-md bg-white lg:flex lg:rounded-none lg:border-1 lg:border-5 lg:border-gray-200'>
			{STEPS.map((step, i) => {
					...
					<div>
						...
						<span className={cn(i !== 0 ? 'lg:pl-9' : '', 'flex items-center px-6 py-4 text-sm font-medium')}>
							...
							<span className='ml-4 h-full mt-0.5 flex min-w-0 flex-col justify-center '>
								<span className={cn("text-sm font-semibold text-zinc-700", {'text-primary': isCompleted, 
